...
import { LoginContext } from "../helper/login/LoginProvider";
...
export default function LoginForm() {
  ...
  // Use the useContext hook to get the login state and actions from the context
      ...
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900 p-5">Sign In</h2>
              <div>
